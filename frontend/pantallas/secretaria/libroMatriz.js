...
import { obtenerLibroMatriz, obtenerLetra,imprimirLibroMatriz } from '../../scripts/secretaria/scriptLibroMatriz.js';
    ...
    const handleConsultar = async () => {
        try {
            ...
            if (alumno.length > 0) {
                ...
                mostrarMensaje('Error','Error al buscar el alumno, verifique el dni.')
            }
        } catch (error) {
