...
import {
  ...
  habilitarMateria,
  modificarMateria,
} from "../../scripts/admin/scriptGestionMaterias.js";
import {
  obtenerMateria,
  obtenerProfesores,
  obtenerProfesorPorMateria,
  obtenerMateriasDeshabilitadas,
  ...
  const cargarListaDesplegable = async () => {
    try {
      ...
      if (materiasObtenidas && Array.isArray(materiasObtenidas)) {
        ...
        console.error(
          "El formato de materias obtenidas no es válido:",
          materiasObtenidas
        );
      }
    } catch (error) {
  ...
  const cargarProfesores = async () => {
    try {
      ...
      if (profesoresObtenidos && Array.isArray(profesoresObtenidos)) {
        ...
        console.error(
          "El formato de profesores obtenidos no es válido:",
          profesoresObtenidos
        );
      }
    } catch (error) {
  ...
  const cargarMateriaProfesor = async () => {
    if (selectedMateria && selectedProfesores.length > 0) {
      ...
      if (result && result.mensaje) {
        mostrarMensaje(
          "Éxito",
          "Relación entre profesores y materia registrada exitosamente"
        );
        limpiarInterfaz();
      } else {
    ...
    mostrarConfirmacion(
      ...
      async () => {
        try {
          ...
          if (
            respuesta &&
            respuesta.mensaje === "Materia deshabilitado exitosamente"
          ) {
            ...
            mostrarMensaje(
              "Error",
              respuesta.mensaje || "Error al deshabilitar la materia"
            );
          }
        } catch (error) {
  ...
  const handleModificar = async () => {
    try {
      ...
      if (!nuevaMateria.trim()) {
        mostrarMensaje(
          "Error",
          "El nuevo nombre de la materia no puede estar vacío"
        );
        return;
      }
        ...
        <View style={styles.fila}>
            ...
            <View style={styles.seleccionadasContainer}>
              <MultiSelect
                ...
                onSelectedItemsChange={(selectedItems) =>
                  setSelectedProfesores(selectedItems)
                } // Actualiza los profesores seleccionados
          ...
          <View style={styles.columna}>
            ...
            <TouchableOpacity
              ...
              onPress={() => setModalModificarVisible(true)}
            >
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <Text style={styles.label}>
                Selecciona una materia existente o escribe una nueva:
              </Text>
              ...
              <View style={styles.botonesModal}>
                ...
                <TouchableOpacity
                  ...
                  onPress={handleRegistrarMateria}
                >
                  <Text style={styles.textoBoton}>Registrar</Text>
                </TouchableOpacity>
              </View>
          ...
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.botonesModal}>
                <TouchableOpacity
                  style={styles.botonAlta}
                  onPress={handleConfirmarHabilitacion}
                >
