...
const api_urlSexo = `${API_BASE_URL}/listaDesplegable/sexo`;
const api_urlCurso = `${API_BASE_URL}/listaDesplegable/curso`;
const api_urlCursoFiltrado = `${API_BASE_URL}/listaDesplegable/curso`;
const api_urlEstadoGeneral = `${API_BASE_URL}/listaDesplegable/estadoGeneral`;
const api_urlLocalidad = `${API_BASE_URL}/listaDesplegable/localidad`;
const api_urlMateria = `${API_BASE_URL}/listaDesplegable/materia`;
const api_urlMateriasDeshabilitadas = `${API_BASE_URL}/listaDesplegable/materia/deshabilitada`;
const api_urlCertificado = `${API_BASE_URL}/listaDesplegable/certificado`;
const api_urlEstadoAsistencia = `${API_BASE_URL}/listaDesplegable/estadoAsistencia`;
const api_urlProfesorPorMateria = `${API_BASE_URL}/listaDesplegable/profesor/materia`;
const api_urlProfesor = `${API_BASE_URL}/listaDesplegable/profesor`;
const api_urlRoles = `${API_BASE_URL}/listaDesplegable/roles`;
const api_urlRolesDeshabilitados = `${API_BASE_URL}/listaDesplegable/roles/deshabilitados`;
const api_urlTareasDeRoles = `${API_BASE_URL}/listaDesplegable/rol/tarea`;
const api_urlTareas = `${API_BASE_URL}/listaDesplegable/tareas`;
const api_urlTareasDeshabilitadas = `${API_BASE_URL}/listaDesplegable/tareas/deshabilitadas`;
const api_urlTareaRol = `${API_BASE_URL}/listaDesplegable/tarea/rol`;
const api_urlRolesDeTarea = `${API_BASE_URL}/listaDesplegable/tarea/rol`;
const api_urlEspecialidad = `${API_BASE_URL}/listaDesplegable/especialidad`;
const api_urlMateriaPorDni = `${API_BASE_URL}/listaDesplegable/alumno/materia`;
const api_urlMateriaPorProfesor = `${API_BASE_URL}/listaDesplegable/materia/profesor`;
...
const api_urlAlumnoCurso = `${API_BASE_URL}/listaDesplegable/alumnos/curso`;
